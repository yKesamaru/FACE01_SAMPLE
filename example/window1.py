...
class ImageBrowser:
    ...
    def on_configure(self, event):
        ...
        for image_path in self.image_list:
            ...
            self.canvas.tag_bind(image_id, '<Double-Button-1>', lambda e, path=image_path: self.show_image(path))
    ...
    def show_image(self, image_path):
        ...
        img = Image.open(image_path)
        img.thumbnail((self.master.winfo_width(), max(1, self.master.winfo_height() // 2)))
        photo = ImageTk.PhotoImage(img)
