...
class Cal:
    ...
    def to_tolerance(self, similar_percentage) -> float:
        ...
        tolerance: float = 0.0
        tolerance_plus: float = (-1*(-0.380952375) + sqrt((-0.380952375)*(-0.380952375)-4*(-4.76190475)*(100-self.similar_percentage))) / (2*(-4.76190475))
        tolerance_minus: float = (-1*(-0.380952375)-sqrt((-0.380952375)*(-0.380952375)-4*(-4.76190475)*(100-self.similar_percentage))) / (2*(-4.76190475))
